// import {Org1, channelType1 } from '../../app/desk-view/component/newpage/network-animation/network-animation.component';
(function($) {
...
// debugger
// ara(data) {
//     channelType1 = data.channel;
// }
// const a = channelType1;
// channelType1.forEach(c => {
...
// });
// $('.demo').fSelect();
// // $('.fs-label').css("line-height", "30px");
// $('.fs-label').css("width", "100px");